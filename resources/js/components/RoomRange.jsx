...
// maximum surface you want to allow

export default function RoomRange({ data, setData, errors }) {
    const [values, setValues] = useState([data.total_rooms || MIN, data.total_rooms_2 || MAX]);

    const handleChange = (newValues) => {
        setValues(newValues);
        setData('total_rooms', newValues[0]);
        setData('total_rooms_2', newValues[1]);
    };
